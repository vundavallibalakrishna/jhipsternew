...
@RestController
@RequestMapping("/api/jhipsternew-kafka")
public class JhipsternewKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsternewKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsternewKafkaResource(KafkaProperties kafkaProperties) {
